...
const App = () => {
  ...
  const setUserReserveAsCollateral = useSwapBorrowRateMode();
  ...
  return (
    <div data-testid="liquuseSwapBorrowRateModeidation-call-container">
      connected
      <button
        data-testid="useSwapBorrowRateMode-call-button"
        onClick={async () => {
          method(knownContracts.BNB, {
...
describe("liquidation call method Tests", () => {
  ...
  test("Should provide liquidation call method", async (done) => {
    await act(async () => {
      ...
      await wrapper.findByTestId("useSwapBorrowRateMode-call-button");
